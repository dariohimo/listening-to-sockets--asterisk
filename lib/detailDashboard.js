...
class DetailDashboard {
		...
		return new Promise(async (resolve, reject) => {
			...
			if(data['Event'] === 'Unhold' || data['Event'] === 'Hangup') {
				setTimeout(async function() {
					...
					if (data['Event'] === 'Newstate' || data['Event'] === 'Hangup' || data['Event'] === 'Hold' || data['Event'] === 'Unhold' || data['Event'] === 'BlindTransfer' || data['Event'] === 'AttendedTransfer')
	...
	attendedTransfer (data) {
		return this.getRequest(data, 'attendedTransfer', '/searchAndUpdate', 'Dashboard : AttendedTransfer', true)
	}
}
