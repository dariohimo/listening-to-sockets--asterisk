...
class EventsCalls {
   ...
   */
	callsOutbound (data) {
		...
		const valuesPostEventID = ['9','13','18','19','20','21','29']
   ...
   */
	...
	pruebas(data, event = false) {
		if (len(data) > 0) {
			console.log('datosPruebas' + event)
			console.log(data)
			...
			console.log(`Pruebas : ${event} ----  Post : ${postEventID}  - Pre : ${preEventID}`)
