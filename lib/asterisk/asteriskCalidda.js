...
class AsteriskCalidda {
	...
	disconnectAsterisk () {
		console.log(`Disconnection on the server -> ${this.asteriskHost}`)
		eventsAsterisk.disconnectAsterisk({nameProyect: 'calidda'})
	}
...
module.exports = AsteriskCalidda
