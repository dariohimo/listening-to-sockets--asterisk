	...
	Hold(sendData) {
		...
		if(len(dataPreUpdate) > 0){
			...
			**/
			...
			if (len(dataPreUpdate.second_outbound_phone) > 0) secondCall = (dataPreUpdate.second_outbound_phone === dataEmitAsterisk['Exten']) ? this.validateHoldinSecondCall(sendData, true) : this.validateHoldinSecondCall(sendData, false)
