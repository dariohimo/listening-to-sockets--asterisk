...
class EnvironmentVariables {
	envAsterisk (nameProyect) {
		...
		case 'calidda':
			variables = {
				'asteriskHost' : process.env.caliddaAsteriskHost,
				'asteriskPort' : process.env.caliddaAsteriskPort,
				'asteriskUsername' : process.env.caliddaAsteriskUsername,
				'asteriskSecret' : process.env.caliddaAsteriskSecret
			}
			break
		}
		return variables
	...
	getPortEndpoint (nameProyect) {
		...
		if (nameProyect === 'calidda') return process.env.portEndpointCalidda
	}
